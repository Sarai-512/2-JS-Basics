...
const markMiller = {
  ...
  mass: 76 ,
  height: 97 ,
  // calcBMI: (markMiller.mass / markMiller.heihgt **2) , my answer 
...
for( let day = 1; day <=7; day++ ){
  console.log(`Today is the ${day}th day of the week`);
}
